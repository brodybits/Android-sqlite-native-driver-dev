/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Tue Aug 18 15:03:00 CEST 2015 ----! */
...
/*   Java->C glue code:
 *   Java package: io.liteglue.SQLiteNative
 *    Java method: int sqlc_db_query_fill_window(long db, long st, long win, int startPos, int offsetParam)
 *     C function: int sqlc_db_query_fill_window(sqlc_handle_t db, sqlc_handle_t st, sqlc_handle_t win, int startPos, int offsetParam);
 */
JNIEXPORT jint JNICALL 
Java_io_liteglue_SQLiteNative_sqlc_1db_1query_1fill_1window__JJJII(JNIEnv *env, jclass _unused, jlong db, jlong st, jlong win, jint startPos, jint offsetParam) {
  int _res;
  _res = sqlc_db_query_fill_window((sqlc_handle_t) db, (sqlc_handle_t) st, (sqlc_handle_t) win, (int) startPos, (int) offsetParam);
  return _res;
}
