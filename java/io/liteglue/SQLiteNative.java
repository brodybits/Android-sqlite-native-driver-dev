...
public class SQLiteNative {
  ...
  /** Interface to C language function: <br> <code> int sqlc_db_query_fill_window(sqlc_handle_t db, sqlc_handle_t st, sqlc_handle_t win, int startPos, int offsetParam); </code>    */
  public static native int sqlc_db_query_fill_window(long db, long st, long win, int startPos, int offsetParam);
